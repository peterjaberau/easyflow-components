...
import { ClickhouseResourceInitial } from '../../../../publicConfig';
import { ClickhouseResource } from '../../../../publicTypes';
...
const ClickhouseConfigElement: FC<BaseConfigElementProps> = (props) => {
  ...
  const content = (findResource?.content ?? ClickhouseResourceInitial) as ClickhouseResource;
    ...
    <>
      <div css={container}>
        ...
        <ControlledElement
          ...
          placeholders={[t('editor.action.resource.db.placeholder.hostname'), '9440']}
          name={['host', 'port']}
          styles={[
            {},
            {
        ...
        {sslOpen && (
          <ControlledElement
            ...
            name="selfSigned"
            contentLabel={t('editor.action.resource.db.label.self_signed_certificate')}
          />
        )}
        {selfSigned && (
          <>

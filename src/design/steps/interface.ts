...
export interface StepsProps extends Omit<HTMLAttributes<HTMLDivElement>, 'onChange'>, BoxProps {
  lineless?: boolean;
  current?: number;
  items?: StepItem[];
...
export interface StepProps extends Omit<HTMLAttributes<HTMLDivElement>, 'title'>, BoxProps {

...
import { DynamoDBResourceInitial } from '../../../../publicConfig';
import { DynamoDBResource, Resource } from '../../../../publicTypes';
import { isCloudVersion } from '../../../../utils';
import { FC, useContext, useMemo } from 'react';
import { useFormContext } from 'react-hook-form';
import { useTranslation } from 'react-i18next';
import { Divider, getColor } from '../../../../../design/react';
    ...
    <>
      <div css={container}>
        ...
        <ControlledElement
          ...
          placeholders={[t('editor.action.resource.db.placeholder.dynamo_region')]}
          name="region"
        />

...
export const SingleYearPicker = forwardRef<HTMLDivElement, SingleYearPickerProps>((props, ref) => {
  const {
    allowClear = true,
    placeholder,
    disabled,
        ...
        content={
          <>
            <YearPickerPanel
              ...
              value={panelValue}
            />
            {extra && <BasicFooterSection disabled={!panelValue} extra={extra} mode="year" />}
          </>
        }
        trigger="click"
        position={position}

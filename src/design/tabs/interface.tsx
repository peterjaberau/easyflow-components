...
export declare type TabAlign = 'flex-start' | 'center' | 'flex-end' | 'space-between' | 'space-around';
...
export interface TabsProps extends Omit<HTMLAttributes<HTMLDivElement>, 'onChange' | 'prefix' | 'suffix'>, BoxProps {
...
export interface TabPaneProps extends Omit<HTMLAttributes<HTMLDivElement>, 'title'> {

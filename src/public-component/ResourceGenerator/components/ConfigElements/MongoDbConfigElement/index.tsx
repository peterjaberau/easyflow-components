...
import { MongoDbResourceInitial } from '../../../../publicConfig';
import { MongoDbConfig, MongoDbResource } from '../../../../publicTypes';
  ...
  return (
    <>
      <div css={container}>
        ...
        />
        {configTypeWatch === 'gui' && <MongoDbGuiMode control={control} watch={watch} resourceID={resourceID} />}
        {configTypeWatch === 'uri' && <MongoDbUriMode control={control} watch={watch} resourceID={resourceID} />}
        ...
        {openSSLWatch && (
          <>
            <ControlledElement
              ...
              name="client"
              placeholders={[t('editor.action.resource.db.placeholder.mongo_certificate')]}
            />
            <ControlledElement
              controlledType={['textarea']}

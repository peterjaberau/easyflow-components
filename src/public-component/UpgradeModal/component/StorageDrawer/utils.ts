...
export const isQuantityDecreased = (quantity: number, driveVolume: DriveVolumeInfo) => quantity < driveVolume.quantity;

export const getDescText = (quantity: number, driveVolume?: DriveVolumeInfo) => {
...
export const geButtonText = (quantity: number, driveVolume?: DriveVolumeInfo) => {
  if (driveVolume && isSubscribeForDrawer(driveVolume?.plan)) {
    if (driveVolume.quantity === quantity) {

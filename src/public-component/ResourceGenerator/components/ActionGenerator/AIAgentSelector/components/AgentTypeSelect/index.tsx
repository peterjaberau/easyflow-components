...
import { DownIcon, SuccessIcon, Trigger, UpIcon, zIndex } from '../../../../../../../design/react';
import { AgentTypeSelectProps } from './interface';
import { optionContentStyle, optionItemStyle, optionLabelStyle, pointerStyle, valueLabelStyle } from './style';

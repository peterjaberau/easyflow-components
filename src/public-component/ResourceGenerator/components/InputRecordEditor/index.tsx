...
import { AddIcon, Button, DeleteIcon, Input, globalColor, illaPrefix } from '../../../../design/react';
import { InputRecordEditorProps } from './interface';
import { applyRecordEditorContainerStyle, recordEditorLabelStyle, recordEditorStyle, recordStyle } from './style';

export const InputRecordEditor: FC<InputRecordEditorProps> = (props) => {
  const { records, label, onDelete, onAdd, onChangeKey, onChangeValue, customRender } = props;
      ...
      <div css={recordEditorStyle}>
        ...
        <span>
          <Button
            ...
            variant="text"
            onClick={onAdd}
            leftIcon={<AddIcon color={globalColor(`--${illaPrefix}-techPurple-08`)} />}
          >

...
const GraphQLIcon = createIcon({
  ...
  path: (
    <>
      <path d="m2.585 17.662.863.498 9.609-16.643-.863-.498-9.609 16.643z" fill="#E535AB" />
      ...
      <path
        ...
        fill="#E535AB"
      />
      <path d="m2.771 7.11.498.863 9.613-5.55-.498-.862L2.77 7.11z" fill="#E535AB" />
      <path
      ...
      <path d="m11.776 21.267.435.753 8.36-4.827-.434-.753-8.36 4.827z" fill="#E535AB" />
      <path

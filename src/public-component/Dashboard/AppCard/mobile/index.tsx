...
import { fromNow, getAuthToken, getILLABuilderURL } from '../../../utils';
import { FC } from 'react';
import { useTranslation } from 'react-i18next';
import { Link, useParams } from 'react-router-dom';
import { Button, Tag } from '../../../../design/react';
...
export const MobileAppCardItem: FC<MobileCardItemProps> = (props) => {
  ...
  return (
    <div css={cardItemContainerStyle}>
      ...
      <p css={descContainerStyle}>{description || t('new_dashboard.desc.no_description')}</p>
      <footer css={cardItemFooterContainerStyle}>
        ...
        {cardType === 'app' && (
          <Link
            ...
            css={linkButtonStyle}
          >
            <Button colorScheme="grayBlue" variant="outline" size="large" w="100%">

    ...
    <div css={shareContainerStyle}>
      ...
      <div css={shareIconContainerStyle}>
        {SocialMediaList.map((platform) => {
          const child = (
            <div key={platform.platform} css={cardContainerStyle} onClick={() => {}}>
          ...
          switch (platform.platform) {
            case PlatformType.X:
              return (
                <TwitterShareButton key={platform.platform} url={props.shareUrl} title={title}>
                  {child}
                </TwitterShareButton>
              );
            case PlatformType.REDDIT:
              return (
                <RedditShareButton key={platform.platform} url={props.shareUrl} title={title}>
                  {child}
                </RedditShareButton>
              );
            case PlatformType.LINKEDIN:
              return (
                <LinkedinShareButton key={platform.platform} url={props.shareUrl} title={title}>
                  {child}
                </LinkedinShareButton>
              );
            ...
            case PlatformType.FACEBOOK:
              return (
                <FacebookShareButton key={platform.platform} url={props.shareUrl} title={title}>
                  {child}
                </FacebookShareButton>
              );
            case PlatformType.WHATSAPP:
              return (
                <WhatsappShareButton key={platform.platform} url={props.shareUrl} title={title}>
                  {child}
                </WhatsappShareButton>
              );
            default:

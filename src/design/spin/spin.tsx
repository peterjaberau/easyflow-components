...
import { applyContainerStyle, applySizeCss, applySpinContainerCss, applyTipsStyle } from './styles';
...
export const Spin = forwardRef<HTMLDivElement, SpinProps>((props, ref) => {
  ...
  return (
    <div css={[applyContainerStyle(block), applyBoxStyle(props)]} ref={ref} {...deleteCssProps(rest)}>
      {children}
      {loading && (

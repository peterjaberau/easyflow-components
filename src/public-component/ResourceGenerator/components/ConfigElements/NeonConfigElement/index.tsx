...
import { neonDefaultPort } from '../../../../publicConfig';
import { NeonResource, Resource } from '../../../../publicTypes';
import { TextLink } from '../../../../TextLink';
import { isCloudVersion, isURL } from '../../../../utils';
import { FC, useCallback, useContext } from 'react';
import { Controller, useFormContext } from 'react-hook-form';
import { Trans, useTranslation } from 'react-i18next';
import { Alert, Button, Input, WarningCircleIcon, getColor } from '../../../../../design/react';
import { ResourceGeneratorContext } from '../../../provider';
import { isContainLocalPath, urlValidate, validateNotEmpty } from '../../../utils';
...
const handleConnectionStringValidate = (inputString: string) => {
  ...
  const { roleName, dbName, hostWithoutPort, password } = getParsedStringValue(inputString);
...
const NeonConfigElement: FC<BaseConfigElementProps> = (props) => {
  ...
  const connectionStringErrorMsg = handleConnectionStringValidate(connectionString);
    ...
    <Trans
      ...
      components={[
        <TextLink
          ...
          onClick={handleDocLinkClick('https://console.neon.tech/app/projects/')}
        />,
      ]}
    />
  );
    ...
    <>
      <div css={container}>
        ...
        <ControlledElement
          ...
          defaultValue={[findResource?.content.host, +(findResource?.content.port ?? neonDefaultPort)]}
          name={['host', 'port']}
                    ...
                    <Trans
                      ...
                      components={[
                        <TextLink
                          ...
                          onClick={handleDocLinkClick('https://www.illacloud.com/docs/illa-cli')}
                        />,
                      ]}
                    />
                  ) : (

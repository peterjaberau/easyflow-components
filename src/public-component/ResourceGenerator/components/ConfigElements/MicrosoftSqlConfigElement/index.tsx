...
import { MicrosoftSqlResourceInitial } from '../../../../publicConfig';
import { MicrosoftSqlResource, Resource } from '../../../../publicTypes';
import { TextLink } from '../../../../TextLink';
import { isCloudVersion } from '../../../../utils';
import { FC, useCallback, useContext, useState } from 'react';
import { Controller, useFormContext } from 'react-hook-form';
import { Trans, useTranslation } from 'react-i18next';
import { Alert, Divider, WarningCircleIcon, getColor } from '../../../../../design/react';
...
const MicrosoftSqlConfigElement: FC<BaseConfigElementProps> = (props) => {
  ...
  const findResource = getResourceByID(resourceID) as Resource<MicrosoftSqlResource>;
    ...
    <>
      <div css={container}>
        ...
        <ControlledElement
          ...
          placeholders={[t('editor.action.resource.db.placeholder.hostname'), '1433']}
          name={['host', 'port']}
          styles={[
            {},
            {
        ...
        <ControlledElement
          ...
          placeholders={[t('editor.action.resource.db.placeholder.database_name')]}
          name="databaseName"
        />
        ...
        <Controller
          ...
          name="connectionOpts"
        />
        <div css={configItemTip}>{t('editor.action.resource.db.tip.connection_options')}</div>

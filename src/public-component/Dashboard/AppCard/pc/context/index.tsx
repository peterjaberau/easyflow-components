...
export const AppListContext = createContext<AppListContextInject>({} as AppListContextInject);

interface AppListContextProviderProps extends AppListContextInject {
  children: ReactNode;
}

export const AppListContextProvider: FC<AppListContextProviderProps> = (props) => {

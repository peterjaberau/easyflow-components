...
export const Comment = forwardRef<HTMLDivElement, CommentProps>((props, ref) => {
  const { placeholder, avatar, actions, author, datetime, children, content, align, ...rest } = props;
  ...
  return (
    <div css={[commentContainerCss, applyBoxStyle(props)]} ref={ref} {...deleteCssProps(rest)}>

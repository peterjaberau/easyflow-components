import { DATABASE_INDEX, generateGraphQLAuthContent, generateSSLConfig } from '../../../../../publicConfig';
import { ResourceType } from '../../../../../publicTypes';
import { FieldValues } from 'react-hook-form';

export const formatTestConnectValues = (data: FieldValues, resourceType: ResourceType) => {
  switch (resourceType) {
    case 'appwrite': {
      return {
        host: data.host.trim(),

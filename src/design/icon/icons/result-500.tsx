...
export const Result500Icon: any = createIcon({
  title: 'Result500Icon',
  viewBox: '0 0 97 97',
  path: (
    <>
      ...
      <path
        ...
        fill="#4672ED"
      />
      <path d="m32.128 68.462-22.025-12.89-.021-5.087 22.025 12.89.021 5.087z" fill="url(.tvol8y2ytb)" />
      <path d="m34.292 59.546-22.035-12.9 20.578-11.958 22.025 12.89-20.568 11.968z" fill="#5880ED" />
      <path
      ...
      <path
        ...
        fill="#4771E7"
      />
      <path d="m32.096 54.627-22.025-12.9-.021-5.087 22.025 12.89.02 5.097z" fill="url(.bdr44hq4je)" />
      <path d="m34.292 45.67-22.035-12.9 20.578-11.958 22.025 12.89L34.292 45.67z" fill="#5880ED" />
      <path

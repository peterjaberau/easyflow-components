import { DatePickerModeType, PrivateCType, RangeDatePickerProps } from '../../interface';
import { Dayjs } from 'dayjs';
import { ReactNode } from 'react';
import React from 'react';

export interface RangePickerPanelProps extends RangeDatePickerProps, PrivateCType {
  disabledDate?: (current: Dayjs) => boolean;
  dateRender?: (currentDate: Dayjs) => ReactNode;
  pageShowDates?: Dayjs[];
  onSelectPanel?: (dateString: string | undefined, date: Dayjs | undefined) => void;
  onPrev?: () => void;
  onSuperPrev?: () => void;
  onNext?: () => void;
  onSuperNext?: () => void;

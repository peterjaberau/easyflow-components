...
import { UploadIcon, AddIcon } from '../icon';
  ...
  return (
    <div css={triggerNodeContainerStyle} {...events}>
      {isValidElement(children) ? (
        ...
        <div css={getPictureCardContainerStyle(!!disabled)} tabIndex={0} aria-label={locale.upload}>
        ...
        <div tabIndex={0} aria-label={locale.dragTip} css={getDragContainerStyle(!!disabled)}>

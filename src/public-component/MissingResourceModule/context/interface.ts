import { ActionContent, ActionItem, Agent, Resource, ResourceContent } from '../../publicTypes';
...
export interface IMissingResourcesProviderProps extends IMissingResourcesContext {
  children: ReactNode;
}

...
import { AppWriteResourceInitial } from '../../../../publicConfig';
import { AppWriteResource } from '../../../../publicTypes';
    ...
    <>
      <div css={container}>
        ...
        <ControlledElement
          ...
          rules={[inputValueValidate]}
          placeholders={[t('editor.action.form.placeholder.appwrite.projectid')]}
          name="projectID"
        />
        <ControlledElement

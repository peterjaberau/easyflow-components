...
// collar
const showCollarDrawerImpl = (from: string, config?: Pick<CollarDrawerShowProps, 'onSuccessCallback' | 'subCycle'>) => {
  const drawer: CollarDrawerShowProps = {
    id: v4(),
    from,
...
const collarDrawerHandler = (from: string, config?: Pick<CollarDrawerShowProps, 'onSuccessCallback' | 'subCycle'>) => {

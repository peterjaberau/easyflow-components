...
export interface PaginationProps extends Omit<HTMLAttributes<HTMLDivElement>, 'onChange'>, BoxProps {
  disabled?: boolean;
  ...
  total?: number;
  itemRender?: (page: number, type: PaginationItemType, originElement: ReactNode) => ReactNode;
  size?: PaginationSize;

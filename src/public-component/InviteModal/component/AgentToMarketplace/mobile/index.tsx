...
export const AgentToMarketplaceMobile: FC<
  Pick<AgentToMarketplaceProps, 'title' | 'onShare' | 'agentID' | 'onCopyAgentMarketLink'>
> = (props) => {
  ...
  return (
    <div css={inviteLinkContainer}>
      ...
      <div css={shareBlockContainerStyle}>
        <ShareBlockMobile onShare={onShare} title={title} shareUrl={getAgentPublicLink(agentID)} />
      </div>
    </div>
  );
};

...
const buildCompletionSources = (completionOptions: { key: string; value: any }[]) => {
...
const getAutoCompletionExtension = (completionOptions: { key: string; value: any }[]) => {
...
export const useBasicSetup = (options: ICodeMirrorOptions) => {
  ...
  const autocompletionExtension = useMemo(() => getAutoCompletionExtension(completionOptions), [completionOptions]);
  ...
  const extensions = useMemo(
    () => [basicExtension, autocompletionExtension, highlightJSExpressionExtension],

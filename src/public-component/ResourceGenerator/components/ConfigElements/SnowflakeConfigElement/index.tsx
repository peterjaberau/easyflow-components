...
import { snowflakeResourceInitial } from '../../../../publicConfig';
import {
...
const SnowflakeConfigElement: FC<BaseConfigElementProps> = (props) => {
  ...
  const content = (findResource?.content ?? snowflakeResourceInitial) as SnowflakeType;
    ...
    <>
      <div css={container}>
        ...
        <ControlledElement
          ...
          placeholders={[t('editor.action.resource.db.placeholder.account_name')]}
          name="accountName"
        />
        <ControlledElement
          controlledType="input"
        ...
        <ControlledElement
          ...
          placeholders={[t('editor.action.resource.db.placeholder.snowflake_database')]}
          name="database"
        />
        <ControlledElement
          controlledType="input"
        ...
        {authenticationType === 'basic' ? (
          <BasicAuthConfig control={control} {...(content.authContent as SnowflakeBasicAuthenticationType)} />
        ) : (
          <KeyPairConfig control={control} {...(content.authContent as SnowflakeKeyAuthenticationType)} />
        )}
      </div>
    </>
  );

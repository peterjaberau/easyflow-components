...
import { MongoDbGuiConfigContentInitial } from '../../../../../publicConfig';
import { MongoDbGuiConfigContent, MongoDbResource, Resource } from '../../../../../publicTypes';
import { TextLink } from '../../../../../TextLink';
import { isCloudVersion } from '../../../../../utils';
import { FC, useCallback, useContext, useState } from 'react';
import { Trans, useTranslation } from 'react-i18next';
import { Alert, getColor } from '../../../../../../design/react';
import { ResourceGeneratorContext } from '../../../../provider';
import { isContainLocalPath } from '../../../../utils';
import { ControlledElement } from '../../../ControlledElement';
import { applyConfigItemLabelText, configItem, configItemTip, connectTypeStyle, labelContainer } from '../../style';
...
export const MongoDbGuiMode: FC<MongoDbConfigModeProps> = (props) => {
  ...
  if (findResource === undefined) {
    ...
    const mongoDbResource = (findResource as Resource<MongoDbResource<MongoDbGuiConfigContent>>).content;
    content = mongoDbResource.configType === 'gui' ? mongoDbResource.configContent : MongoDbGuiConfigContentInitial;
  }

  const [showAlert, setShowAlert] = useState<boolean>(false);

  const connectionFormat = watch('connectionFormat', content.connectionFormat ?? 'standard');
    ...
    <>
      ...
      <ControlledElement
        ...
        options={[
          {
            value: 'standard',
            label: t('editor.action.resource.db.label.mongodb_connection_standard'),
          },
          {
            value: 'mongodb+srv',
            label: t('editor.action.resource.db.label.mongodb_connection_dns_seed_list'),
          },
        ]}
      />

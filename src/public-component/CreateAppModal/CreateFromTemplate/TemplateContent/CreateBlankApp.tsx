...
export const CreateBlankAPP: FC<ICreateBlankAppProps> = (props) => {
  const { isInModal, handleCreateBlankApp, closeModal, handleOpenCreateFromResource } = props;
  const { t } = useTranslation();
  return (
    <div css={baseContentContainerStyle}>
      <span css={contentTitleStyle}>{t('new_dashboard.create_new.create_an_app')}</span>
      <CreateOptions
        isInModal={isInModal}

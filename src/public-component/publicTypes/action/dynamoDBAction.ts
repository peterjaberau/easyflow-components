export type DynamoActionMethods = 'query' | 'scan' | 'putItem' | 'getItem' | 'updateItem' | 'deleteItem';
...
export interface DynamoUpdateItemStructParams extends Omit<DynamoPutItemStructParams, 'item'> {
  key: string;
  updateExpression: string;
}

export type DynamoDeleteItemStructParams = Omit<DynamoUpdateItemStructParams, 'updateExpression'>;

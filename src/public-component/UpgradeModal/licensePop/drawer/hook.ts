...
const showDrawerImpl = (from: string, config: Pick<DrawerShowProps, 'defaultConfig'>) => {
  const drawer: DrawerShowProps = {
    id: v4(),
    from,
...
const drawerHandler = (from: string, config: Pick<DrawerShowProps, 'defaultConfig'>) => {

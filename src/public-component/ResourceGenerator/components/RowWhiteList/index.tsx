...
import { Card, CopyIcon, DownIcon, UpIcon, useMessage } from '../../../../design/react';
    ...
    <div>
      <div css={whiteListContentContainerStyle}>
        <div css={whiteListContentStyle}>
          <div css={whiteListTitleStyle}>{t('editor.action.resource.tip.allowlist.title')}</div>
          <div css={whiteListDescriptionStyle}>{t('editor.action.resource.tip.allowlist.message')}</div>
        </div>
        {isCloudVersion && (
          <div css={whiteListButtonContainerStyle}>
            ...
            <span css={whiteListOperationIconStyle} onClick={handleOperationIconClick}>

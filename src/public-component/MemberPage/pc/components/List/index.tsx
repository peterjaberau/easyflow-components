...
import { getCurrentMemberList, getCurrentTeamInfo, teamActions } from '../../../../UserData';
import { FC, useCallback, useMemo } from 'react';
import { useTranslation } from 'react-i18next';
import { useDispatch, useSelector } from 'react-redux';
import { Table, useMessage } from '../../../../../design/react';
  ...
  const tableColumns = useMemo(
    () => [
      ...
      },
      {
        ...
        cell: (props: Record<string, any>) => {
          const value = props.getValue();
          const executedUserRole = value.userRole !== USER_ROLE.OWNER ? [USER_ROLE.OWNER] : [];
          return (
            <RoleSelector

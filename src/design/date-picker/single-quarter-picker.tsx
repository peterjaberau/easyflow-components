...
import { GetHeaderOperationsFun, DatePickerModeType, SingleQuarterPickerProps } from './interface';
...
export const SingleQuarterPicker = forwardRef<HTMLDivElement, SingleQuarterPickerProps>((props, ref) => {
  const {
    allowClear = true,
    placeholder,
    disabled,

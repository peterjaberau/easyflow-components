...
import { getOAuthStatusContentStyle, oAuthErrorIconStyle, oAuthStatusContainerStyle } from './style';
...
const GoogleSheetsConfigElement: FC<BaseConfigElementProps> = (props) => {
  ...
  const content = (findResource?.content ?? GoogleSheetResourceInitial) as GoogleSheetResource;
  ...
  const isAuthenticated = content.opts?.status === GoogleSheetAuthStatus.Authenticated;
              ...
              <Trans
                ...
                components={[
                  <TextLink
                    ...
                    onClick={handleLinkTo('https://console.cloud.google.com/cloud-resource-manager')}
                  />,
                  <TextLink
                    key="editor.action.form.tips.gs.private_key.docs"
                    onClick={handleLinkTo('https://cloud.google.com/docs/authentication/getting-started')}
                  />,
                  <TextLink
                    key="editor.action.form.tips.gs.private_key.limit"
                    onClick={handleLinkTo('https://developers.google.com/sheets/api/limits')}
                  />,
                ]}
              />
            }

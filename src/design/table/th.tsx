...
import { applyBorderStyle, applyContentContainer, applySizeStyle, applyThStyle, thContentStyle } from './style';
...
export const Th = forwardRef<HTMLTableHeaderCellElement, ThProps>((props, ref) => {
  ...
  return (
    <th
      css={css(
        applyThStyle(),
        applySizeStyle(size ?? tableContext?.size ?? 'medium', customCellPadding ?? tableContext?.customCellPadding),
        applyBorderStyle(

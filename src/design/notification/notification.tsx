...
import { applyBoxStyle, getColor } from '../theme';
import {
  applyContentStyle,
  ...
  const normalIcon: ReactNode = useMemo(() => {
    if (showIcon) {
      if (icon) {
        ...
        switch (type) {
          case 'info':
            return <InfoCircleIcon mt="2px" fs="16px" c={getColor('blue', '03')} />;
          case 'error':
            return <ErrorCircleIcon fs="16px" mt="2px" c={getColor('red', '03')} />;
          case 'success':
            return <SuccessCircleIcon fs="16px" mt="2px" c={getColor('green', '03')} />;
          case 'warning':
            return <WarningCircleIcon fs="16px" mt="2px" c={getColor('orange', '03')} />;
          case 'normal':
          default:
            return <></>;
        }

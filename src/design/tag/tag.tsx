...
export const Tag = forwardRef<HTMLDivElement, TagProps>((props, ref) => {
  const { visible, colorScheme = 'gray', size = 'medium', variant = 'light', clickable, closable, ...rest } = props;
  ...
  return (visible == undefined ? realVisible : visible) ? (
    <div css={[finalStyle, applyBoxStyle(props)]} ref={ref} {...deleteCssProps(otherProps)}>

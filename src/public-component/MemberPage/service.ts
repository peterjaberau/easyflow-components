...
export const fetchRemoveTeamMember = (currentTeamID: string, teamMemberID: string) => {
...
export const fetchChangeTeamMemberRole = (currentTeamID: string, teamMemberID: string, userRole: USER_ROLE) => {
  return authCloudRequest(
    {
      method: 'PATCH',
...
export const fetchUpdateTeamPermissionConfig = (currentTeamId: string, data: IUpdateTeamPermissionConfigRequest) => {
  return authCloudRequest(
    {
      method: 'PATCH',
      url: '/permission',

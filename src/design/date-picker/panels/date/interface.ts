...
import { PrivateCType, SingleDatePickerProps, DatePickerModeType } from '../../interface';

export interface DatePickerPanelProps extends SingleDatePickerProps, PrivateCType {

...
import { AirtableResourceInitial } from '../../../../publicConfig';
import { AirtableResource } from '../../../../publicTypes';
...
const AirtableConfigElement: FC<BaseConfigElementProps> = (props) => {
  ...
  const content = (findResource?.content ?? AirtableResourceInitial) as AirtableResource;
            ...
            <Trans
              ...
              components={[
                <TextLink
                  key={'TextLink'}
                  onClick={() => {
                    handleURLClick('https://support.airtable.com/docs/creating-and-using-api-keys-and-access-tokens');
                  }}
                />,
              ]}
            />

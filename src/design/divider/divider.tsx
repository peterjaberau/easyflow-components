...
export const Divider = forwardRef<HTMLDivElement, DividerProps>((props, ref) => {
  ...
  switch (direction) {
    case 'vertical':
      dividerCss = applyDividerContainerVertical(colorScheme, variant, 'center');
      break;
    case 'horizontal':
      dividerCss = applyDividerContainerHorizontal(colorScheme, variant, 'center');
      break;
  }
  ...
  if (text && text?.length > 0) {
    ...
    return <div css={[dividerCss, applyBoxStyle(props)]} ref={ref} {...deleteCssProps(otherProps)} />;
  }
});

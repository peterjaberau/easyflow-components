...
import { RadioGroup, Search } from '../../../../../design/react';
...
import { bodyContainerStyle, containerStyle, headerContainerStyle } from './style';
...
export const AIAgentSelector: FC<ActionResourceSelectorProps> = (props) => {
  ...
  const [sortedBy, setSortedBy] = useState<MARKET_AGENT_SORTED_OPTIONS>(MARKET_AGENT_SORTED_OPTIONS.POPULAR);
  ...
  return (
    <div css={containerStyle}>
      <div css={bodyContainerStyle}>
        ...
        {agentType === 'team' && (
          <TeamAgentList onSelect={handleClickCreateAction} search={searchKeywords} key={searchKeywords} />
        )}
        {agentType === 'community' && (
          <MarketAgentList

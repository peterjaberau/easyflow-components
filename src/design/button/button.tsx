...
export const Button: any = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
  return (
    <ButtonGroupContext.Consumer>
      {(value) => {
        ...
        const finalContainer = css`
          ...
          ${hasPropContent ? applyPaddingStyle(size, variant) : applyWithoutTextSize(size, fullWidth, fullHeight)};
        ...
        return (
          ...
          >
            {(loading || leftIcon) && (
              <span css={hasPropContent ? applyLeftIconStyle(size, hasChild) : applyIconWithoutText(size)}>
            ...
            {rightIcon && (
              <span css={hasPropContent ? applyRightIconStyle(size, hasChild) : applyIconWithoutText(size)}>
                {rightIcon}
              </span>
            )}
          </button>

...
import { Button, PreviousIcon } from '../../../../design/react';
...
const NOT_NEED_TEST_CONNECT_RESOURCE_TYPE = ['restapi', 'googlesheets', 'airtable', 'huggingface', 'hfendpoint'];
  ...
  return (
    <div css={headerOuterContainerStyle}>
      <div css={headerContainerStyle}>
        <div>
          <Button leftIcon={<PreviousIcon />} variant="text" colorScheme="gray" type="button" onClick={onClickBack}>
            {t('back')}
          </Button>
        </div>
        <div css={titleContainerStyle}>
          <div css={titleNameContainerStyle}>
            ...
            <h1 css={titleNameStyle}>{getResourceNameFromResourceType(resourceType)}</h1>
          </div>

...
import { CopyIcon, SuccessCircleIcon } from '../icon';
import { globalColor, illaPrefix } from '../theme';
import React from 'react';

export class Copyable {
  copyIcon: ReactNode = (<CopyIcon color={globalColor(`--${illaPrefix}-grayBlue-01`)} />);
  copiedIcon: ReactNode = (<SuccessCircleIcon color={globalColor(`--${illaPrefix}-green-03`)} />);

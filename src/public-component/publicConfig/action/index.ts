import { ACTION_RUN_TIME, ActionContent, ActionItem, IAdvancedConfig, IMockConfig, Transformer } from '../../publicTypes';
...
export const actionItemInitial: Pick<ActionItem<ActionContent>, 'transformer' | 'triggerMode'> = {

...
import { operationIconStyle, basicHeaderStyle, iconGroupStyle, headerWrapperStyle, headerLabelStyle } from './style';
  ...
  return (
    <div css={basicHeaderStyle}>
      ...
      <div css={headerWrapperStyle}>
        <HeaderLabel value={value} mode={mode} title={title} onChangePanel={onChangePanel} />
      </div>
      <div css={iconGroupStyle}>

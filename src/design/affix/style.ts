...
export function applyFixedPosition(positionValue: PositionValue): SerializedStyles {
  return css`
    position: fixed;
...
export function applyAffixFixedStyle(affixFixedValue: AffixFixedValue, w: number, h: number): SerializedStyles {

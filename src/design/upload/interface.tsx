...
export type UploadRequestProps = (options: RequestOptions) => UploadRequestReturn | void;
...
export interface UploadProps {
  ...
  onRemove?: (file: UploadItem, fileList: UploadItem[]) => boolean | Promise<any>;
...
export type RequestOptions = Pick<UploadProps, 'headers' | 'name' | 'data' | 'action'> & {

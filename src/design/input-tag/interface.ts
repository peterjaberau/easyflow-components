import { InputHTMLAttributes, KeyboardEvent, MutableRefObject, ReactNode, SyntheticEvent } from 'react';
...
export interface InputTagProps
  extends Omit<InputHTMLAttributes<HTMLInputElement>, 'prefix' | 'size' | 'onChange' | 'value' | 'defaultValue'>,
    BoxProps {
  ...
  onRemove?: (value: TagObject | string, index: number, e: SyntheticEvent) => void;
  validate?: (inputValue: string, values: string[] | TagObject[]) => boolean | Promise<boolean>;

...
export type DescriptionLayout = 'horizontal' | 'vertical' | 'inline-horizontal' | 'inline-vertical';
...
export interface DescriptionProps extends HTMLAttributes<HTMLDivElement>, BoxProps {

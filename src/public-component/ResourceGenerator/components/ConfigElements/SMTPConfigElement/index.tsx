...
import { SMTPResourceInitial } from '../../../../publicConfig';
import { Resource, SMTPResource } from '../../../../publicTypes';
    ...
    <>
      <div css={container}>
        ...
        <ControlledElement
          ...
          placeholders={[t('editor.action.resource.db.placeholder.hostname'), '25']}
          styles={[
            {
              flex: 4,
            },

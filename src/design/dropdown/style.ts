...
import { getColor, getSpecialThemeColor, globalColor, hasNineStepColor, illaPrefix } from '../theme';
  ...
  const hoverCss = css`
    ...
    &:hover {
      ...
      background-color: ${deleted
        ? getColor('red', '07')
        : getColor(hoverColorScheme, hasNineStepColor(hoverColorScheme) ? '09' : '08')};
    }
  `;

import { getColor, getSpecialThemeColor } from '../theme';
...
export function applyBgColor(colorScheme: SliderColorScheme | undefined, disabled: boolean): string {
  if (disabled) {
...
export function applyMarkBar(disabled: boolean, colorScheme?: SliderColorScheme): SerializedStyles {
  return css`
...
export function applyTickContainer(left: number, disabled: boolean): SerializedStyles {
  return css`
    height: 5px;
    width: 8px;
    position: absolute;
...
export function applyNumTick(left: number, disabled: boolean): SerializedStyles {
  return css`
    height: 22px;
    width: 15px;
    position: absolute;

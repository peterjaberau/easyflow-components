...
import { getStringSnippets } from '../../../../dynamicStringUtils';
...
export const buildIllaContextCompletionSource = (
...
): ((context: CompletionContext) => CompletionResult | Promise<CompletionResult | null> | null) => {
  return (context: CompletionContext) => {
    ...
    if (validString.text.length === 0 && context.matchBefore(/\{\{\s*/) === null) {
      return null;
    }

...
import { Drawer } from '../../../design/react';
...
export const MobileCloudDashboardLayout: FC<MobileDashBoardLayoutProps> = (props) => {
  const { children, dynamicMenu, tipsComponent, drawerVisible, bottomComponent, setDrawerVisible } = props;
  ...
  return (
    <div css={mobileLayoutContainerStyle}>
      <header css={headerContainerStyle}>
        ...
        <Avatar size={40} id={userInfo.userID} name={userInfo.nickname} avatarUrl={userInfo.avatar} />
      </header>

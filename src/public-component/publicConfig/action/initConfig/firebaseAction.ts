...
export const FirebaseInitialValue = {
  ...
  [FirebaseAuthActionTypeValue.GET_USER_BY_EMAIL]: FirebaseGetUserByEmailInitial,
  [FirebaseAuthActionTypeValue.GET_USER_BY_PHONE]: FirebaseGetUserByPhoneInitial,
  ...
  [FirebaseStoreActionTypeValue.GET_DOCUMENT_BY_ID]: FirebaseGetDocumentByIDInitial,
  [FirebaseStoreActionTypeValue.DELETE_ONE_DOCUMENT]: FirebaseDeleteDocumentInitial,
  [FirebaseStoreActionTypeValue.GET_COLLECTIONS]: FirebaseGetCollectionsInitial,
  [FirebaseStoreActionTypeValue.QUERY_COLLECTION_GROUP]: FirebaseQueryCollectionGroupInitial,
  [FirebaseRealtimeActionTypeValue.QUERY_DATABASE]: FirebaseQueryDatabaseInitial,
  ...
  [FirebaseRealtimeActionTypeValue.APPEND_DATA_TO_LIST]: FirebaseAppendDataToListInitial,
};

...
export const Avatar: FC<AvatarProps> = (props) => {
  ...
  return (
    <div className={className} css={applyAvatarStyle(avatarBgColor, emptyStatus, size)} {...otherProps}>
      {avatarUrl ? <img css={avatarImgStyle} src={avatarUrl} alt="avatar" /> : avatarText}
    </div>
  );
};

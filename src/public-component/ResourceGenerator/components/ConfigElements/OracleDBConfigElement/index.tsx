...
import { OracleResourceInitial } from '../../../../publicConfig';
import { OracleResource } from '../../../../publicTypes';
...
const OracleDBConfigElement: FC<OracleDBConfigElementProps> = (props) => {
  ...
  const content = (findResource?.content as OracleResource) ?? OracleResourceInitial;

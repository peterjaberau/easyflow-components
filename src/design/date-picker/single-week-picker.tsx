...
import { GetHeaderOperationsFun, DatePickerModeType, SingleWeekPickerProps } from './interface';
...
export const SingleWeekPicker = forwardRef<HTMLDivElement, SingleWeekPickerProps>((props, ref) => {
  const {
    allowClear = true,
    placeholder,
    disabled,

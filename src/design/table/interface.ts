...
export type TableAlign = 'left' | 'center' | 'right' | 'start' | 'end' | 'flex-start' | 'flex-end';
...
export interface TableProps<D extends TableData, TValue>
  ...
  onPaginationChange?: (paginationState: PaginationState, table: Table<D>) => void;
...
export interface TBodyProps extends HTMLAttributes<HTMLTableSectionElement>, BoxProps {}
...
export interface TFootProps extends HTMLAttributes<HTMLTableSectionElement>, BoxProps {}

export interface THeadProps extends HTMLAttributes<HTMLTableSectionElement>, BoxProps {
  pinedHeader?: boolean;
}

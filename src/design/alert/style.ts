...
import { getColor, globalColor, illaPrefix } from '../theme';
...
export function applyAlertContainer(type: AlertType, showBanner?: boolean, hasContent?: boolean): SerializedStyles {

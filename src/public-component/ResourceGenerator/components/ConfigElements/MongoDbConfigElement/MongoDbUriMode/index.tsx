...
import { MongoDbUriConfigContentInitial } from '../../../../../publicConfig';
import { MongoDbResource, MongoDbUriConfigContent, Resource } from '../../../../../publicTypes';
...
export const MongoDbUriMode: FC<MongoDbConfigModeProps> = (props) => {
  ...
  if (findResource === undefined) {
    ...
    const mongoDbResource = (findResource as Resource<MongoDbResource<MongoDbUriConfigContent>>).content;
    content = mongoDbResource.configType === 'uri' ? mongoDbResource.configContent : MongoDbUriConfigContentInitial;
  }
  ...
  return (
    <ControlledElement
      ...
      placeholders={['mongodb+srv://admin:password@host/mydb?retryWrites=true&w=majority']}

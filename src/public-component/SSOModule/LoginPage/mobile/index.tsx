    ...
    <form css={formStyle} onSubmit={handleSubmit(onSubmit)}>
      ...
      <div css={formItemStyle}>
        ...
        {(formState?.errors.password || errorMsg.password) && (
          <div css={errorMsgStyle}>{formState?.errors.password?.message || errorMsg.password}</div>
        )}
      </div>
      ...
      {isCloudVersion && !hideOAuth && (
        <div css={oAuthButtonGroupStyle}>
          <OAuthButton icon={<GithubIcon css={oAuthIconStyle} />} type="github" isMobile landing="signin" />
        </div>
      )}
    </form>
  );

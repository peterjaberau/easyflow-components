...
import { FirebaseResourceInitial } from '../../../../publicConfig';
import { FirebaseResource, Resource } from '../../../../publicTypes';
import { TextLink } from '../../../../TextLink';
import { isCloudVersion } from '../../../../utils';
import { FC, useContext } from 'react';
import { Controller, useFormContext } from 'react-hook-form';
import { Trans, useTranslation } from 'react-i18next';
import { Divider, Popover, TextArea, WarningCircleIcon, getColor } from '../../../../../design/react';
        ...
        <div css={privateKeyItem}>
          ...
          >
            <div css={labelContainer}>
              <span css={applyConfigItemLabelText(getColor('red', '03'))}>*</span>
          ...
          <Controller
            ...
            defaultValue={content.privateKey && JSON.stringify(content.privateKey)}
            render={({ field: { value, onChange, onBlur } }) => (
              <TextArea
                ...
                value={value}
                autoSize
                placeholder={t('editor.action.resource.db.placeholder.private_key')}
              />
            )}
            name="privateKey"
          />
          ...
          <Trans
            ...
            components={[
              <TextLink
                key="go-to-setup"
                onClick={() => {
                  window.open('https://firebase.google.com/docs/admin/setup', '_blank');
                }}
              />,
            ]}
          />

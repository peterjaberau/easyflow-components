...
import { CloseIcon, Drawer, TriggerProvider } from '../../../../design/react';
import { AgentToMarketplaceMobile } from '../../component/AgentToMarketplace/mobile';
import { MarketShareAgentProps } from '../interface';
import { closeIconContainerStyle, contentContainerStyle, inviteHeaderContainerStyle, inviteModalStyle } from './style';

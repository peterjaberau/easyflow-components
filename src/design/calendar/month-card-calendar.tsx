...
import { NextDoubleIcon, PreviousDoubleIcon } from '../icon';
...
export const MonthCardCalendar = forwardRef<HTMLDivElement, CardCalendarProps>((props, ref) => {
  ...
  return (
    <div ref={ref} css={[monthCardContainerStyle, applyBoxStyle(otherProps)]} {...deleteCssProps(otherProps)}>
        ...
        {Array.from({ length: 12 }).map((_, index) => {
          return (
            <div
              ...
              css={applyMonthBlockStyle(value.year() === currentDate.year() && value.month() === index, colorScheme)}
              onClick={() => {

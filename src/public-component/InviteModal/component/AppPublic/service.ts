...
export const updateAppPublicConfig = async (isPublic: boolean, teamID: string, appID: string) => {
...
export const makeAppContribute = (teamID: string, appID: string, hashtags?: string[]) => {

...
import { GCS_OBJECT_TYPE } from '../publicTypes';
import React from 'react';
import { ILLA_DRIVE_OBJECT_TYPE, getFileTypeByContentType } from '../utils';
...
export const getFileIconByILLAFileType = (type: ILLA_DRIVE_OBJECT_TYPE, iconStyle?: SerializedStyles) => {
  switch (type) {

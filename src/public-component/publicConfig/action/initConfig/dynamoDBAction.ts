...
export const DynamoDBInitialMap: Record<DynamoActionMethods, DynamoStructParams> = {
...
export const DynamoActionStructParamsDataTransferType: Record<string, object | number> = {
  expressionAttributeNames: {},
  expressionAttributeValues: {},
  key: {},
  item: {},

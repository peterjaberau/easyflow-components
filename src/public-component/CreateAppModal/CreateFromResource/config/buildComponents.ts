import { CONTAINER_TYPE, ComponentTreeNode } from '../../../publicTypes';
import { v4 } from 'uuid';
...
const buildNumberInput = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
  ...
  return {
    ...
    childrenNode: [],
    props: {
      value: view === FORM_VIEW.EDIT ? `{{dataGrid1.selectedRows[0].${valueKey}}}` : '{{1}}',
      label: labelKey,
      labelAlign: 'left',
      labelPosition: 'top',
      labelWidth: '{{33}}',
...
const buildSlider = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
  ...
  return {
    ...
    childrenNode: [],
    props: {
      value: view === FORM_VIEW.EDIT ? `{{dataGrid1.selectedRows[0].${valueKey}}}` : '{{0}}',
      min: '{{0}}',
      max: '{{10}}',
      step: '{{1}}',
      label: labelKey,
      ...
      hidden: false,
      formDataKey: `{{${displayName}.displayName}}`,
      $dynamicAttrPaths: ['value', 'min', 'max', 'step', 'labelWidth', 'formDataKey'],
    },
    version: 0,
  };
};

const buildRate = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
const buildSelect = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
const buildRadioButton = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
  ...
  return {
    ...
    props: {
      ...
      dataSources: '{{[]}}',
      colorScheme: 'blue',
      value: view === FORM_VIEW.EDIT ? `{{dataGrid1.selectedRows[0].${valueKey}}}` : '',
      hidden: false,
      formDataKey: `{{${displayName}.displayName}}`,
      $dynamicAttrPaths: ['labelWidth', 'dataSources', 'formDataKey', 'value'],
    },
...
const buildRadio = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
const buildDate = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
  ...
  return {
    ...
    childrenNode: [],
    props: {
      value: view === FORM_VIEW.EDIT ? `{{dataGrid1.selectedRows[0].${valueKey}}}` : undefined,
...
const buildDateTime = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
const buildTime = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
const buildInput = (
  ...
  return {
    ...
    props: {
      ...
      $dynamicAttrPaths: ['labelWidth', 'formDataKey', 'showVisibleButton', 'value'],
      type: inputType,
      pattern,
...
const buildTextArea = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
const buildEditableText = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
const buildCascader = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
const buildSwitch = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
const buildCheckbox = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
const buildMultiSelect = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
const buildSwitchGroup = (valueKey: string, index: number, view: FORM_VIEW, labelKey: string): ComponentTreeNode => {
...
export const getNodesAboutForm = (rows: DatasetTableRows[]) => {
  ...
  rows.forEach((row, index) => {
    ...
    switch (inputType.value) {
      ...
      case FORM_WIDGET_TYPE.URL:
      case FORM_WIDGET_TYPE.PASSWORD:
        addInput = buildInput(name, index, inputType.value, FORM_VIEW.ADD, label);
        editInput = buildInput(name, index, inputType.value, FORM_VIEW.EDIT, label);
        break;
    }
...
export const buildDivider = (view: FORM_VIEW, index: number): ComponentTreeNode => {
...
export const buildDataGrid = (sqlType: RESOURCE_TYPE, rows: DatasetTableRows[]): ComponentTreeNode => {

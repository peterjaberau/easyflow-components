import { ActionContent, ActionItem, ComponentTreeNode, Resource } from '../../publicTypes';

export interface CreateWithResourceProps {
  closeModal?: () => void;
  getResourceLoading?: boolean;
  resourceList: Resource[];
  createCallBack: (appInfo: ComponentTreeNode, actionsInfo: BuildActionInfo[]) => void;
...
export type BuildActionInfo = Omit<ActionItem<ActionContent & ActionEvent>, 'actionID'>;

...
import { ACTION_MANAGE, ATTRIBUTE_GROUP, canManage, isBiggerThanTargetRole } from '../../../UserRoleUtils';
...
export const ShareAgentPC: FC<ShareAgentProps> = (props) => {
  ...
  if (props.canInvite && props.canUseBillingFeature && USER_ROLE.VIEWER === props.currentUserRole) {
    defTab = ShareAgentTab.SHARE_WITH_TEAM;
  } else if (isBiggerThanTargetRole(USER_ROLE.VIEWER, props.currentUserRole) || props.defaultAgentContributed) {
  ...
  return (
    ...
    >
      <div css={headerContainerStyle}>
        ...
        >
          {props.canInvite && (
            <TabPane title={t('user_management.modal.tab.with_team')} key={ShareAgentTab.SHARE_WITH_TEAM} />
          )}
          {(canManage(
            ...
            <TabPane title={t('user_management.modal.title.contribute')} key={ShareAgentTab.TO_MARKETPLACE} />
          )}
        </Tabs>
        <div
          css={closeIconStyle}
      ...
      <div css={contentContainerStyle}>
        {activeTab === ShareAgentTab.TO_MARKETPLACE && props.agentID !== '' && props.agentID !== undefined && (

...
import { Modal, getColor, useMessage } from '../../../../design/react';
      ...
      onOk={async () => {
        ...
        try {
          if (props.productContributed) {
            await updateAgentContribute(props.teamID, props.productID, currentHashtags);
          } else {
            await contributeAgentWithHashtags(props.teamID, props.productID, currentHashtags);
          }

...
export interface ShareAppProps
  extends Omit<InviteByEmailProps, 'defaultInviteUserRole' | 'redirectURL' | 'excludeUserRole'>,
    Omit<InviteLinkProps, 'defaultInviteUserRole' | 'onCopyInviteLink' | 'redirectURL' | 'excludeUserRole'>,

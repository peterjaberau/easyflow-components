...
import { applyVerticalMenuItemContainer, verticalSubMenuIcon, verticalSubMenuLabel } from './style';

export const VerticalMenuItem = forwardRef<HTMLDivElement, VerticalMenuItemProps>((props, ref) => {
  const { selected, disabled, icon, label, value, sub, hidden, ...otherProps } = props;
  ...
  return (
    <div
      css={[
        applyVerticalMenuItemContainer(colorScheme, hoverColorScheme, selected, disabled, sub),

...
import { Button, CloseIcon, Modal, Spin, useMessage } from '../../design/react';
...
export const AvatarUpload: FC<AvatarUploadProps> = (props) => {
  ...
  const [cropSize, setCropSize] = useState(isMobile ? MOBILE_FILE_INIT_CROP_SIZE : FILE_INIT_CROP_SIZE);
      ...
      {file && (
        ...
        >
          <Spin _css={loadingStyle} loading={loading} colorScheme="techPurple">
            <span css={applyModalTitleStyle}>{t('image.crop.modal.title')}</span>
            ...
            <div css={applyControlContainerStyle}>
              <div css={rowStyle}>
                ...
                />
                <RotateRightIcon css={rotateStyle} onClick={() => setRotation(rotation + 90)} />
              </div>
              <Button _css={buttonStyle} colorScheme="techPurple" onClick={handleCrop}>

...
import { S3ResourceInitial } from '../../../../publicConfig';
import { Resource, S3ACL, S3Resource } from '../../../../publicTypes';
import { TextLink } from '../../../../TextLink';
import { isCloudVersion } from '../../../../utils';
import { FC, useContext } from 'react';
import { useFormContext } from 'react-hook-form';
import { Trans, useTranslation } from 'react-i18next';
import { Divider, WarningCircleIcon, getColor } from '../../../../../design/react';
    ...
    <>
      <div css={container}>
            ...
            <Trans
              ...
              components={[
                <TextLink
                  ...
                  onClick={() => {
                    window.open('https://docs.aws.amazon.com/AmazonS3/latest/userguide/cors.html', '_blank');
                  }}
                />,
              ]}
            />
        ...
        <ControlledElement
          ...
          contentLabel={t('editor.action.resource.s3.label.use_custome_s3_endpoint')}
        ...
        <ControlledElement
          ...
          name="accessKeyID"
          controlledType="input"
          tips={isCloudVersion && t('editor.action.resource.db.tip.username_password')}
        />
        <ControlledElement

...
export const getCurrentUserId: any = createSelector([getCurrentUser], (currentUser) => {
...
export const getCanApplyAppSumo = (state: RootState) =>
  state.currentUser?.haveAppSumoSubscription && !state.currentUser?.doesAppSumoSubscriptionAppliedToTeam;

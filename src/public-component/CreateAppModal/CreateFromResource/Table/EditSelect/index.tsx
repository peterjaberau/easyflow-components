...
import { GridRenderEditCellParams, GridValidRowModel, useGridApiContext } from '@mui/x-data-grid-premium';
import { FC, useCallback, useMemo, useState } from 'react';
import { Select, SelectOptionObject, SelectValue, isString } from '../../../../../design/react';
...
const EditSelect: FC<GridRenderEditCellParams<GridValidRowModel, EditSelectProps, string>> = (props) => {

...
const ElasticSearchConfigElement = lazy(() => import('./ElasticSearchConfigElement'));
const FirebaseConfigElement = lazy(() => import('./FirebaseConfigElement'));
const GoogleSheetsConfigElement = lazy(() => import('./GoogleSheetsConfigElement'));
const GraphQLConfigElement = lazy(() => import('./GraphQLConfigElement'));
const HuggingFaceConfigElement = lazy(() => import('./HuggingFaceConfigElement'));
const HuggingFaceEndpointConfigElement = lazy(() => import('./HuggingFaceEndpointConfigElement'));
const MicrosoftSqlConfigElement = lazy(() => import('./MicrosoftSqlConfigElement'));

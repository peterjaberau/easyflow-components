...
import { TriggerPosition, TriggerProps } from '../trigger';
import { Dayjs } from 'dayjs';
import { InputColorScheme, InputSize } from './input/interface';
import { TimePickerProps, RangePickerProps } from '../time-picker';
...
export interface PublicDatePickerProps extends BoxProps {
  ...
  onPickerValueChange?: (dateString: string | undefined, value: Dayjs | undefined) => void;

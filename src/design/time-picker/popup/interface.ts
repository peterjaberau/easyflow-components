...
import { TimePickerProps, RangePickerProps, TimePickerValue } from '../interface';
...
export interface AmPmColumnProps
  extends Omit<BaseColumnProps, 'step' | 'hideDisabledOptions' | 'disabledFunc' | 'selectedValue'> {
  format: string;
  valueShow: DayjsPro;

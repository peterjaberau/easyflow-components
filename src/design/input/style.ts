...
export function applyInputStyle(
  ...
  return css`
    ...
    background-color: ${variant === 'fill' ? (error ? getColor('red', '07') : getColor('grayBlue', '09')) : 'unset'};

    border: 1px solid
      ${variant === 'outline' ? (error ? getColor('red', '03') : getColor('grayBlue', '08')) : 'transparent'};
    ...
    &:hover {
      ...
      background-color: ${variant === 'fill' ? (error ? getColor('red', '06') : getColor('grayBlue', '08')) : 'unset'};
...
export function applyPrefixStyle(size: InputSize, disabled: boolean): SerializedStyles {
  return css`
    flex-shrink: 0;
    display: inline-flex;
    align-items: center;
...
export function applySuffixStyle(size: InputSize, disabled: boolean): SerializedStyles {
  return css`
    display: inline-flex;
    align-items: center;
    justify-content: center;

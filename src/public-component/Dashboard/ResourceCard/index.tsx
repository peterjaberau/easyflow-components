...
import { Button, PenIcon } from '../../../design/react';
...
export const ResourceCard: FC<CardProps> = (props) => {
  const { resourceType, resourceName, dbName, resourceID, onEditResource, onDeleteResource } = props;
    ...
    <div css={resourceCardContainerStyle}>
      <header css={headerContainerStyle}>
        <div css={resourceIconAndNameContainerStyle}>
          <Suspense fallback={<div>Loading...</div>}>{getIconFromResourceType(resourceType, '24px')}</Suspense>

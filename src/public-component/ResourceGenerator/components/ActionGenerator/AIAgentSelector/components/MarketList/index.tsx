...
import { MARKET_AGENT_SORTED_OPTIONS, fetchMarketAgentList } from '../../../../../../MarketAgent';
...
export const MarketAgentList: FC<MarketAgentListProps> = (props) => {
  const { onSelect, search, sortBy = MARKET_AGENT_SORTED_OPTIONS.POPULAR } = props;
        ...
        itemCount === 0 ? (
          ...
          >
            {(props: ListChildComponentProps<MarketAIAgent[]>) => {
              ...
              return <MarketListItem item={data[index]} onSelected={handleClickFork} style={style} />;
            }}
          </FixedSizeList>
        )
      }

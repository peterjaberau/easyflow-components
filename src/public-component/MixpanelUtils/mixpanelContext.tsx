...
import { ILLAProperties, ILLA_MIXPANEL_EVENT_TYPE, ILLA_PAGE_NAME } from './interface';
...
export const MixpanelTrackProvider: FC<MixpanelTrackProviderProps> = (props) => {
  ...
  return <MixpanelTrackContext.Provider value={injectValue}>{children}</MixpanelTrackContext.Provider>;
};

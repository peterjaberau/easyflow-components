...
import { CouchdbResourceInitial } from '../../../../publicConfig';
import { CouchdbResource } from '../../../../publicTypes';
...
const CouchDBConfigElement: FC<BaseConfigElementProps> = (props) => {
  ...
  const content = findResource ? (findResource.content as CouchdbResource) : CouchdbResourceInitial;
